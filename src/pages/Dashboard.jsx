...
export default function Dashboard() {
  ...
  const handleResultHistory = async () => {
    try {
      let temp_data = []
      const response = await fetch('https://servers-pa.vercel.app/api/result'); // Ganti 'URL_API/results' dengan URL endpoint API hasil result kamu
  ...
  const handleResultHistoryStruk = async () => {
    try {
      let temp_data = []
      const response = await fetch('https://servers-pa.vercel.app/api/resultstruk'); // Ganti 'URL_API/results' dengan URL endpoint API hasil result kamu
      const data = await response.json();
      for(let i = 0; i < data.length; i++){
        if(data[i].username == sessionStorage.getItem('name')){
          temp_data.push({
  ...
  const handleResultHistoryStruk2 = async () => {
    try {
      let temp_data = []
      const response = await fetch('https://servers-pa.vercel.app/api/resultstruk2'); // Ganti 'URL_API/results' dengan URL endpoint API hasil result kamu
      const data = await response.json();
      for(let i = 0; i < data.length; i++){
        if(data[i].username == sessionStorage.getItem('name')){
          temp_data.push({
  ...
  const handleResultHistoryStruk3 = async () => {
    try {
      let temp_data = []
      const response = await fetch('https://servers-pa.vercel.app/api/resultstruk3'); // Ganti 'URL_API/results' dengan URL endpoint API hasil result kamu
      const data = await response.json();
      for(let i = 0; i < data.length; i++){
        if(data[i].username == sessionStorage.getItem('name')){
          temp_data.push({
  ...
  const handleResultHistoryStruk5 = async () => {
    try {
      let temp_data = []
      const response = await fetch('https://servers-pa.vercel.app/api/resultstruk5'); // Ganti 'URL_API/results' dengan URL endpoint API hasil result kamu
      const data = await response.json();
      for(let i = 0; i < data.length; i++){
        if(data[i].username == sessionStorage.getItem('name')){
          temp_data.push({
  ...
  const handleResultHistoryStruk4 = async () => {
    try {
      let temp_data = []
      const response = await fetch('https://servers-pa.vercel.app/api/resultstruk4'); // Ganti 'URL_API/results' dengan URL endpoint API hasil result kamu
      const data = await response.json();
      for(let i = 0; i < data.length; i++){
        if(data[i].username == sessionStorage.getItem('name')){
          temp_data.push({
  ...
  const handleResultHistoryStruk6 = async () => {
    try {
      let temp_data = []
      const response = await fetch('https://servers-pa.vercel.app/api/resultstruk6'); // Ganti 'URL_API/results' dengan URL endpoint API hasil result kamu
      const data = await response.json();
      for(let i = 0; i < data.length; i++){
        if(data[i].username == sessionStorage.getItem('name')){
          temp_data.push({
  ...
  const handleResultHistoryBim = async () => {
    try {
      let temp_data = []
      const response = await fetch('https://servers-pa.vercel.app/api/resultbim'); // Ganti 'URL_API/results' dengan URL endpoint API hasil result kamu
      const data = await response.json();
      for(let i = 0; i < data.length; i++){
        if(data[i].username == sessionStorage.getItem('name')){
          temp_data.push({
  ...
  const handleResultHistoryBim2 = async () => {
    try {
      let temp_data = []
      const response = await fetch('https://servers-pa.vercel.app/api/resultbim2'); // Ganti 'URL_API/results' dengan URL endpoint API hasil result kamu
      const data = await response.json();
      for(let i = 0; i < data.length; i++){
        if(data[i].username == sessionStorage.getItem('name')){
          temp_data.push({
  ...
  const handleResultHistoryMan = async () => {
    try {
      let temp_data = []
      const response = await fetch('https://servers-pa.vercel.app/api/resultman'); // Ganti 'URL_API/results' dengan URL endpoint API hasil result kamu
      const data = await response.json();
      for(let i = 0; i < data.length; i++){
        if(data[i].username == sessionStorage.getItem('name')){
          temp_data.push({
  ...
  const handleResultHistoryMan2 = async () => {
    try {
      let temp_data = []
      const response = await fetch('https://servers-pa.vercel.app/api/resultman2'); // Ganti 'URL_API/results' dengan URL endpoint API hasil result kamu
      const data = await response.json();
      for(let i = 0; i < data.length; i++){
        if(data[i].username == sessionStorage.getItem('name')){
          temp_data.push({
  ...
  const handleResultHistoryPost = async () => {
    try {
      let temp_data = []
      const response = await fetch('https://servers-pa.vercel.app/api/resultpost'); // Ganti 'URL_API/results' dengan URL endpoint API hasil result kamu
      const data = await response.json();
      for(let i = 0; i < data.length; i++){
        if(data[i].username == sessionStorage.getItem('name')){
          temp_data.push({
  ...
  const handleResultHistoryPost2 = async () => {
    try {
      let temp_data = []
      const response = await fetch('https://servers-pa.vercel.app/api/resultpost2'); // Ganti 'URL_API/results' dengan URL endpoint API hasil result kamu
      const data = await response.json();
      for(let i = 0; i < data.length; i++){
        if(data[i].username == sessionStorage.getItem('name')){
          temp_data.push({
        ...
        <div className="p-4  mt-14">
            <div className="grid grid-cols-3 gap-4 mb-4">
                <div className="col-span-2 flex flex-col items-start">
                  ...
                  <p className="text-[40px] font-bold text-[#9A3B3B] mt-5">Mari Kita Belajar Sandhangan</p>
                </div>
              ...
              <div className="border-yellow-700 border-2 rounded-xl drop-shadow-xl w-80 flex flex-col items-center justify-center">
                ...
                <p className="text-[#9A3B3B] mt-4 text-center">Halooo, kenalin aku Joko, disini aku akan menemani kamu dalam belajar sandhangan aksara Jawa, yuk belajar sama aku, pertama mengerjakan pretest, belajar materi, mengerjakan latihan terstruktur 1, 2, 3, latihan terbimbing, latihan mandiri, dan posttest yang harus kamu lakukan lhoo, semangat yaa</p>
              </div>
              <div className="mt-4">
