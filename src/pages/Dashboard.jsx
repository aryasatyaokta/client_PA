...
export default function Dashboard() {
  ...
  const handleResultHistory = async () => {
    try {
      let temp_data = []
      const response = await fetch('http://localhost:5000/api/result'); // Ganti 'URL_API/results' dengan URL endpoint API hasil result kamu
  ...
  const handleResultHistoryStruk = async () => {
    try {
      let temp_data = []
      const response = await fetch('http://localhost:5000/api/resultstruk'); // Ganti 'URL_API/results' dengan URL endpoint API hasil result kamu
      const data = await response.json();
      for(let i = 0; i < data.length; i++){
        if(data[i].username == sessionStorage.getItem('name')){
          temp_data.push({
  ...
  const handleResultHistoryStruk2 = async () => {
    try {
      let temp_data = []
      const response = await fetch('http://localhost:5000/api/resultstruk2'); // Ganti 'URL_API/results' dengan URL endpoint API hasil result kamu
      const data = await response.json();
      for(let i = 0; i < data.length; i++){
        if(data[i].username == sessionStorage.getItem('name')){
          temp_data.push({
  ...
  const handleResultHistoryStruk3 = async () => {
    try {
      let temp_data = []
      const response = await fetch('http://localhost:5000/api/resultstruk3'); // Ganti 'URL_API/results' dengan URL endpoint API hasil result kamu
      const data = await response.json();
      for(let i = 0; i < data.length; i++){
        if(data[i].username == sessionStorage.getItem('name')){
          temp_data.push({
  ...
  const handleResultHistoryStruk5 = async () => {
    try {
      let temp_data = []
      const response = await fetch('http://localhost:5000/api/resultstruk5'); // Ganti 'URL_API/results' dengan URL endpoint API hasil result kamu
      const data = await response.json();
      for(let i = 0; i < data.length; i++){
        if(data[i].username == sessionStorage.getItem('name')){
          temp_data.push({
  ...
  const handleResultHistoryStruk4 = async () => {
    try {
      let temp_data = []
      const response = await fetch('http://localhost:5000/api/resultstruk4'); // Ganti 'URL_API/results' dengan URL endpoint API hasil result kamu
      const data = await response.json();
      for(let i = 0; i < data.length; i++){
        if(data[i].username == sessionStorage.getItem('name')){
          temp_data.push({
  ...
  const handleResultHistoryStruk6 = async () => {
    try {
      let temp_data = []
      const response = await fetch('http://localhost:5000/api/resultstruk6'); // Ganti 'URL_API/results' dengan URL endpoint API hasil result kamu
      const data = await response.json();
      for(let i = 0; i < data.length; i++){
        if(data[i].username == sessionStorage.getItem('name')){
          temp_data.push({
  ...
  const handleResultHistoryBim = async () => {
    try {
      let temp_data = []
      const response = await fetch('http://localhost:5000/api/resultbim'); // Ganti 'URL_API/results' dengan URL endpoint API hasil result kamu
      const data = await response.json();
      for(let i = 0; i < data.length; i++){
        if(data[i].username == sessionStorage.getItem('name')){
          temp_data.push({
  ...
  const handleResultHistoryBim2 = async () => {
    try {
      let temp_data = []
      const response = await fetch('http://localhost:5000/api/resultbim2'); // Ganti 'URL_API/results' dengan URL endpoint API hasil result kamu
      const data = await response.json();
      for(let i = 0; i < data.length; i++){
        if(data[i].username == sessionStorage.getItem('name')){
          temp_data.push({
  ...
  const handleResultHistoryMan = async () => {
    try {
      let temp_data = []
      const response = await fetch('http://localhost:5000/api/resultman'); // Ganti 'URL_API/results' dengan URL endpoint API hasil result kamu
      const data = await response.json();
      for(let i = 0; i < data.length; i++){
        if(data[i].username == sessionStorage.getItem('name')){
          temp_data.push({
  ...
  const handleResultHistoryPost = async () => {
    try {
      let temp_data = []
      const response = await fetch('http://localhost:5000/api/resultpost'); // Ganti 'URL_API/results' dengan URL endpoint API hasil result kamu
      const data = await response.json();
      for(let i = 0; i < data.length; i++){
        if(data[i].username == sessionStorage.getItem('name')){
          temp_data.push({
  ...
  const handleResultHistoryPost2 = async () => {
    try {
      let temp_data = []
      const response = await fetch('http://localhost:5000/api/resultpost2'); // Ganti 'URL_API/results' dengan URL endpoint API hasil result kamu
      const data = await response.json();
      for(let i = 0; i < data.length; i++){
        if(data[i].username == sessionStorage.getItem('name')){
          temp_data.push({
