...
export default function Struktur3() {
            ...
            <div className="col-span-2 justify-center items-center rounded-lg bg-gray-50 h-fulll dark:bg-gray-800">
              ...
              <div className='flex flex-col items-center justify-center'>
                <div className='start my-16'>
                  <Link className='btn bg-[#9A3B3B] py-3 px-14 text-white rounded-md' to={'/quiz-lat-struktur2'} onClick={startQuiz}>Start Latihan</Link>
                </div>
              </div>
            </div>
          </div>
