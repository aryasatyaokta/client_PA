...
/** import actions  */
import { resetAllActionStruk } from '../../redux/questionstruk_reducer';
import { usePublishResultStruk } from '../../hooks/setResult';
import { resetResultActionStruk } from '../../redux/resultstruk_reducer';
...
export default function ResultStruk() {
    ...
    console.log("Answers:", answerStruk);
    console.log("Result:", resultsStruk);
    ...
    usePublishResultStruk({ 
        resultsStruk, 
        username : userIdStruk,
        attempts,
        points: earnPoints,
        achived : flag ? "Passed" : "Failed" });

    function onRestart(){
        dispatch(resetAllActionStruk())
        dispatch(resetResultActionStruk())
    }
        ...
        <div className="p-4  mt-14">
          <div className="grid grid-cols-3 gap-4 mb-4 font-[Poppins]">
            <div className="col-span-2 justify-center items-center rounded-lg bg-gray-50 h-[600px] dark:bg-gray-800">
              <p className='text-xl font-bold text-[#9A3B3B] text-center my-5'>Hasil Latihan Terstruktur Aksara Jawa</p>
              <div className=''>
              ...
              <div className='flex flex-col items-center my-10'>
                <div className='py-4 border-2 border-[#9A3B3B] w-1/2 h-full'>
                  <div className='flex justify-between px-2'>
                    <span>Username :</span>
                    <span className='font-bold'>{userIdStruk || 0}</span>
                  </div>
