            ...
            (async () => {
                try {
                    if (result.length !== 0 && username) {
                        await postServerData(`https://servers-pa.vercel.app/api/result`, resultData, (data) => data);
            ...
            (async () => {
                try {
                    if (result !== 0 && username) {
                        await postServerDataStruk(`https://servers-pa.vercel.app/api/resultstruk`, resultData, (data) => data);
                        console.log('Successfully posted data');
                        setIsDataSent(true);
                    } else {
                        throw new Error("Couldn't get result or username");
    ...
    useEffect(() => {
        if (resultData && !isDataSent) {
            ...
            (async () => {
                try {
                    if (result !== 0 && username) {
                        await postServerDataBim(`https://servers-pa.vercel.app/api/resultbim`, resultData, (data) => data);
                        console.log('Successfully posted data');
                        setIsDataSent(true);
                    } else {
                        throw new Error("Couldn't get result or username");
    ...
    useEffect(() => {
        if (resultData && !isDataSent) {
            ...
            (async () => {
                try {
                    if (result !== 0 && username) {
                        await postServerDataMan(`https://servers-pa.vercel.app/api/resultman`, resultData, (data) => data);
                        console.log('Successfully posted data');
                        setIsDataSent(true);
                    } else {
                        throw new Error("Couldn't get result or username");
    ...
    useEffect(() => {
        if (resultData && !isDataSent) {
            ...
            (async () => {
                try {
                    if (result !== 0 && username) {
                        await postServerDataStruk2(`https://servers-pa.vercel.app/api/resultstruk2`, resultData, (data) => data);
                        console.log('Successfully posted data');
                        setIsDataSent(true);
                    } else {
                        throw new Error("Couldn't get result or username");
    ...
    useEffect(() => {
        if (resultData && !isDataSent) {
            ...
            (async () => {
                try {
                    if (result !== 0 && username) {
                        await postServerDataBim2(`https://servers-pa.vercel.app/api/resultbim2`, resultData, (data) => data);
                        console.log('Successfully posted data');
                        setIsDataSent(true);
                    } else {
                        throw new Error("Couldn't get result or username");
    ...
    useEffect(() => {
        if (resultData && !isDataSent) {
            ...
            (async () => {
                try {
                    if (result !== 0 && username) {
                        await postServerDataMan2(`https://servers-pa.vercel.app/api/resultman2`, resultData, (data) => data);
                        console.log('Successfully posted data');
                        setIsDataSent(true);
                    } else {
                        throw new Error("Couldn't get result or username");
    ...
    useEffect(() => {
        if (resultData && !isDataSent) {
            ...
            (async () => {
                try {
                    if (result !== 0 && username) {
                        await postServerDataPost(`https://servers-pa.vercel.app/api/resultpost`, resultData, (data) => data);
                        console.log('Successfully posted data');
                        setIsDataSent(true);
                    } else {
                        throw new Error("Couldn't get result or username");
    ...
    useEffect(() => {
        if (resultData && !isDataSent) {
            ...
            (async () => {
                try {
                    if (result !== 0 && username) {
                        await postServerDataPost2(`https://servers-pa.vercel.app/api/resultpost2`, resultData, (data) => data);
                        console.log('Successfully posted data');
                        setIsDataSent(true);
                    } else {
                        throw new Error("Couldn't get result or username");
    ...
    useEffect(() => {
        if (resultData && !isDataSent) {
            ...
            (async () => {
                try {
                    if (result !== 0 && username) {
                        await postServerDataStruk3(`https://servers-pa.vercel.app/api/resultstruk3`, resultData, (data) => data);
                        console.log('Successfully posted data');
                        setIsDataSent(true);
                    } else {
                        throw new Error("Couldn't get result or username");
    ...
    useEffect(() => {
        if (resultData && !isDataSent) {
            ...
            (async () => {
                try {
                    if (result !== 0 && username) {
                        await postServerDataStruk4(`https://servers-pa.vercel.app/api/resultstruk4`, resultData, (data) => data);
                        console.log('Successfully posted data');
                        setIsDataSent(true);
                    } else {
                        throw new Error("Couldn't get result or username");
    ...
    useEffect(() => {
        if (resultData && !isDataSent) {
            ...
            (async () => {
                try {
                    if (result !== 0 && username) {
                        await postServerDataStruk5(`https://servers-pa.vercel.app/api/resultstruk5`, resultData, (data) => data);
                        console.log('Successfully posted data');
                        setIsDataSent(true);
                    } else {
                        throw new Error("Couldn't get result or username");
    ...
    useEffect(() => {
        if (resultData && !isDataSent) {
            ...
            (async () => {
                try {
                    if (result !== 0 && username) {
                        await postServerDataStruk6(`https://servers-pa.vercel.app/api/resultstruk6`, resultData, (data) => data);
                        console.log('Successfully posted data');
                        setIsDataSent(true);
                    } else {
                        throw new Error("Couldn't get result or username");
